...
= Вывод
В ходе выполнения лабораторной работы я изучил уровни изоляции транзакций,
освоил создание нагрузочных тестов с использованием Apache JMeter
и реализовал дополнительные ограничения на уровне бизнес-логики.
